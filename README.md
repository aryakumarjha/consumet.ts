...
<p align="center">
  ...
  <a href="https://github.com/aryakumarjha/consumet.ts/actions/workflows/npm-publish.yml">
    <img src="https://github.com/aryakumarjha/consumet.ts/actions/workflows/npm-publish.yml/badge.svg" alt="npm (scoped)">
  </a>
    ...
    <a href="https://discord.gg/qTPfvMxzNH">
      ...
      <a href="https://github.com/aryakumarjha/consumet.ts/blob/master/LICENSE">
...
Do you want to know more? Head to the [`Getting Started`](https://github.com/aryakumarjha/consumet.ts/tree/master/docs/guides/getting-started.md).

## Documentation
- [`Getting Started`](./docs/guides/getting-started.md)
- [`Guides`](https://github.com/aryakumarjha/consumet.ts/tree/master/docs)
...
- [Examples](https://github.com/aryakumarjha/consumet.ts/tree/master/examples) - examples of using consumet.ts.
- [Provider Status](https://github.com/consumet/providers-status/blob/main/README.md) - A list of providers and their status.
- [Changelog](https://github.com/aryakumarjha/consumet.ts/blob/master/CHANGELOG.md) - See the latest changes.
- [Discord Server](https://discord.gg/qTPfvMxzNH) - Join our discord server and chat with the maintainers.

## Provider Request
Make a new [issue](https://github.com/aryakumarjha/consumet.ts/issues/new?assignees=&labels=provider+request&template=provider-request.yml) with the name of the provider on the title, as well as a link to the provider in the body paragraph.

## Contributing
Check out [contributing guide](https://github.com/aryakumarjha/consumet.ts/blob/master/CONTRIBUTING.md) to get an overview of consumet.ts development.
...
[![](https://contrib.rocks/image?repo=consumet/consumet.ts)](https://github.com/aryakumarjha/consumet.ts/graphs/contributors)
